...
<div class="container text-center" >
  ...
  <div class="row">
    <div class="col-sm-4" style="background-color: #1bbab3; border: 1px solid #01292b; border-radius: 10px" >
       ...
       <div class="col-sm-4">
      <!-- <img src="images/signup-page-images.jpg"> 
       </div>
	   -->
			...
			<div class="col-xs-6">
				...
				<div >
					<div class="panel-title-sign mt-xl text-right">
						<h3 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> Sign In</h3>
					</div>
					<div class="panel-body">
						<form class="form-horizontal" action="#" method="post" name="form1"  style = "font-weight: bold;  text-align: center;">
							<div class="form-group mb-lg">
								
								<div class="input-group input-group-icon">
									<input type="text" size="40" name="user_login" id="user_login" placeholder="User Name"  title="" class="form-control input-lg" />
							...
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input type="password" size="40" name="password_login" id="password_login"  placeholder="Passowrd" value=""  class="form-control input-lg" />
									<span class="input-group-addon">
										<span class="icon icon-lg">
							...
							<div class="row">
								...
								<div class="col-sm-4 text-right">
									<input type="submit"  class="button button2" name="button" id="button" value="Sign In">
								</div>
							</div>
