...
{
echo "<meta http-equiv=\"refresh\" content=\"0; url=http://localhost:81/social_network/sumon/test/index.php\">";
exit();
}
}
}
...
<img style="padding: 3px; border: 1px solid #ddd; border-radius: 4px;" src="images/profile_pic.jpg" height="150" width="150"/><br/><p><?php
//include ("./inc/header.inc.php");
echo $_SESSION['user_login'];
?>'s Profile</p>
</a>
