...
function anim() {
    $("#wrap img.bgfade").first().appendTo('#wrap').fadeOut(2500);
    $("#wrap img").first().fadeIn(2500);
    setTimeout(anim, 20000);
}
anim();})
...
<div class="container-fluid" style="color:#fff;height:auto; ">
	...
	<img class="img-responsive" src="images/logo_howdy.png" id = "center" class="img" alt="logo_howdy" /> <div class="container"><hr /></div>
...
<img class="bgfade" src="images/2.jpg">
<img class="bgfade" src="images/3.jpg">
<img class="bgfade" src="images/1.jpg">
<img class="bgfade" src="images/4.jpg">
<img class="bgfade" src="images/5.jpg">
<img class="bgfade" src="images/6.jpg">
<img class="bgfade" src="images/7.jpg">
