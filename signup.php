...
<div class="container text-center" >
  ...
  <section class="body-sign">
		  <div class="row">
			<div class="col-xs-6" >
			  <div class="jumbotron" >
				<a href="/" class="logo pull-left">
					<img src="images/logo_howdy.png" height="54" alt="Porto Admin" />
				</a>

				<div>
					<div class="panel-title-sign mt-xl text-right">
						<h3 class="title text-uppercase text-weight-bold m-none"><i class="fa fa-user mr-xs"></i> Sign Up</h3>
					</div>
					<div >
						...
						<form class="form-horizontal" action="#" method="post" style = "  text-align: center; ">
							...
							<div class="form-group">
								...
								<input type="text" size="40" name="lname" class="form-control input-sm" title="Last Name" placeholder="Last Name" value="<?php echo $ln; ?>"/><br />
							...
							<div class="form-group">
								...
								<input type="text" size="40" name="email" class="form-control input-sm" title="Email" placeholder="Email" value="<?php echo $em; ?>"/><br />
							</div>
							<div class="form-group">
								
								<input type="text" size="40" name="email2" class="form-control input-sm" title="Repeat Email" placeholder="Re-Enter Email" value="<?php echo $em2; ?>"/><br />
							</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-6 mb-sm">
										...
										<input type="password" size="40" name="password2" class="form-control input-sm" placeholder="Re-Enter Passowrd" value="" /><br />
									</div>
								</div>
							</div>
			...
			<div class="col-xs-4" >
			<img src="images/gree.png" style="opacity:.4; text-align:center; max-height:auto; max-width:200%;" align="middle" align="middle" alt="Porto Admin" />
			</div>
			</div>
		  </div>
		</section>
