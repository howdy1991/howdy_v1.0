...
<div class="msg-container">
	<div class="header">Messenger</div><hr>
		...
		if(message != "" ){
			...
			xmlhttp.onreadstatechange = function(){
				...
				console.log(xmlhttp.responseText)
					document.getElementById("msg-area").innerHTML += "<div class=\"msgc\" style=\"margin-bottom: 30px;\"> <div class=\"msg msgfrom\">" + message + "</div> <div class=\"msgarr msgarrfrom\"></div> <div class=\"msgsentby msgsentbyfrom\">Sent by " + username + "</div> </div>";
				msginput.value = "";
				}
			}
