...
<div class="container text-center" >
  ...
  <div class="row">
    <div class="col-sm-6" >
	   ...
	   <div class="col-sm-6" >
	    <form class="form-horizontal" action="index.php" method="post" name="form1"  style = "font-weight: bold; border: 1px solid; border-style: single; color: #fff; text-align: center;">
            <h2>Already a Memeber? Login below ...</h2><hr></br/>
			  ...
			  <div class="form-group">
				...
				<input type="text" size="40" name="password_login" id="password_login"  placeholder="Passowrd" value="" /><p /><div>
				  <div class="form-group">
