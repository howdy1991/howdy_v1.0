...
function addNameSection(){
	...
	$("#nameBoxWrap").append('<tr id="nameBox'+addSectionCount+'"><td></td><td><input type="file" id="name'+addSectionCount+'" name="fileToUpload[]"></td><td><input type="button"  class="button" value="REMOVE" onclick=removeNameSection("'+addSectionCount+'")></td></tr>');
}
...
<div id="container">
    ...
    <div id="wrapper">
		<div class="wrap_box">
			<form name="frmSection" id="frmSection" method="post">
				...
				<input type="button" value="ADD MORE" onclick="addNameSection()" class="button">
				<input type="button" name="submit" value="Submit" onclick="submitSection()"  class="button">
