...
<html>
    <head>
        <title>Chat-Box Design With Pop-ups</title>
	...
	background-color: rgba(217,217,217,1.00);
        ...
        <script>
            ...
            function register_popup(id, name)
            {
				...
				element = element + '<div style="clear: both"></div></div><div>input</div>';
        ...
        <div class="chat-sidebar">
            <div class="sidebar-name">
                ...
                <a href="javascript:register_popup('narayan-prusty', 'Narayan Prusty');">
                    <img width="30" height="30" src="images/profile_pic/defaultprofile_pic.jpg" />
