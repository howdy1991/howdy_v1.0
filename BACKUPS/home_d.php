    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
		  ...
		  <li class="active"><a href="account_settings.php"><span class="glyphicon glyphicon-home"> Account Settings</span></a></li>
...
<a target="_blank" href="images/profile_pic.jpg">
<img style="padding: 2px; border: 1px solid #ddd; border-radius: 4px;" src="images/profile_pic.jpg" height="150" width="150"/><br/><p><?php
echo $_SESSION['user_login'];
?>'s Profile</p>
</a>
</div>
