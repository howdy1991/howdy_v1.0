    ...
    <div class="col-sm-4" style="background-color: #1bbab3; border: 1px solid #01292b; border-radius: 10px" >
	   ...
	   <div class="col-sm-4" style="background-color: #1bbab3; border: 1px solid #01292b; border-radius: 10px" >
	    <form class="form-horizontal" action="#" method="post" name="form1"  style = "font-weight: bold; color: #fff; text-align: center;">
			...
			<h1 style = "text-align: center; font-weight: bold;">Thanks For Your Help and Support!</h1>
			<img class="img-responsive" src="images/logo_howdy.png" id = "center" style="width: 35%; height: 35%; background-position: center;" alt="logo_howdy" > 
			</div>
